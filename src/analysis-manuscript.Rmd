...
Jacques-Hamilton, R., Valcu, M., Kwon, E.K., Versluijs, T., & Kempenaers, B. (2024). Measurement error in remotely sensed fractional snow cover datasets: implications for ecological research.
...
I'll use paired t.tests, and compare the results to the equivalent non-parametric test (Wilcoxon signed rank test
). They give the same conclusions, so the paired t.test is used in the manuscript.
```{r}
